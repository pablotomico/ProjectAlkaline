...
namespace alk
{
    namespace GameLogic
    {
        ...
        constexpr uint GRID_WIDTH = 50;
        constexpr uint GRID_HEIGHT = 50;
        constexpr uint TILE_WIDTH = 32;
        constexpr uint TILE_WIDTH_HALF = 16;
        constexpr uint TILE_HEIGHT = 16;
        constexpr uint TILE_HEIGHT_HALF = 8;
